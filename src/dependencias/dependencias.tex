...
% PREAMBULO - Aquí es donde se incluyen los paquetes adicionales
...
\usepackage[pdftex,
    ...
    pdftitle={Sistema de Gestión de Incidentes de Búsqueda y Rescate en el Mar}, % DONE
...
\usepackage{xcolor} % Para manejo de colores
\usepackage{caption} % Para personalizar las leyendas de figuras y tablas
\usepackage{placeins} % Para controlar la ubicación de figuras
\usepackage[bottom=1in,footskip=0.4in]{geometry} % Para ajustar márgenes y el espacio para notas al pie
\usepackage[hang,flushmargin]{footmisc} % Opciones para alinear y espaciar notas al pie
...
%               {<before with label>}{<before without >}
